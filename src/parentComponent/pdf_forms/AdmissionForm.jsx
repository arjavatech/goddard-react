...
import PDFFormInput from '../../components/PDFFormInput';
    ...
    const generatePrint = async (isPrint = false) => {
        ...
        try {
            ...
            for (let i = 1; i <= 20; i += 2) {
                const s1 = document.getElementById(`section${i}`);
                const s2 = document.getElementById(`section${i + 1}`);
                ...
                if (printWindow) {
                    printWindow.addEventListener('load', () => {
                        setTimeout(() => {
                            ...
                            // Listen for window close (cancel button)
                        ...
                        <div className="px-4 sm:px-6">
                            <div className="grid grid-cols-3 gap-6 px-4 sm:px-6 py-6">
                                ...
                                <PDFFormInput
                                    ...
                                    defaultValue={initialFormData?.primary_language || ''}
                                />
                            ...
                            <div className="grid grid-cols-2 gap-6 px-4 sm:px-6 py-6">
                                <div>
                                    ...
                                    <PDFFormInput
                                        id="school_age_child_school"
                                        name="school_age_child_school"
                                        defaultValue={initialFormData?.school_age_child_school || ''}
                                    />
                                </div>
                                <div>
                                    ...
                                    <PDFFormInput
                                        ...
                                        defaultValue={initialFormData?.primary_parent_info?.parent_home_telephone_number || ''}
                                    />
                                ...
                                <div>
                                    ...
                                    <PDFFormInput
                                        id="parent_name"
                                        name="parent_name"
                                        defaultValue={initialFormData?.primary_parent_info?.parent_name || ''}
                                    />
                                </div>

                                <PDFFormInput
                                    id="do_relevant_custody_papers_apply1"
                                    name="do_relevant_custody_papers_apply"
                                    label="DO RELEVANT CUSTODY PAPERS APPLY?"
                                    defaultValue={initialFormData?.do_relevant_custody_papers_apply || ''}
                                />

                                <PDFFormInput
                                    id="parent_street_address"
                                    name="parent_street_address"
                                    label="STREET"
                                    defaultValue={initialFormData?.primary_parent_info?.parent_street_address || ''}
                                />
                                <PDFFormInput
                                    id="parent_city_address"
                                    name="parent_city_address"
                                    label="CITY"
                                    defaultValue={initialFormData?.primary_parent_info?.parent_city_address || ''}
                                />
                            ...
                            <div className="grid grid-cols-3 gap-6 px-4 sm:px-6 py-6">
                                <PDFFormInput
                                    ...
                                    name="business_name"
                                    label="NAME"
                                    defaultValue={initialFormData?.primary_parent_info?.parent_business_name || ''}
                                />
                                <PDFFormInput
                                    id="parent_state_address"
                                    name="parent_state_address"
                                    label="STATE"
                                    defaultValue={initialFormData?.primary_parent_info?.parent_state_address || ''}
                                />

                                <div>
                                    <PDFFormInput
                                        id="parent_zip_address"
                                        name="parent_zip_address"
                                        label="ZIP"
                                        defaultValue={initialFormData?.primary_parent_info?.parent_zip_address || ''}
                                    />
                                    <span id="parent_zip_address_span" style={{ display: 'none' }}>
                                        Enter valid input [only numbers].
                                    </span>
                                </div>
                                ...
                                <PDFFormInput
                                    ...
                                    defaultValue={initialFormData?.primary_parent_info?.parent_work_hours_from || ''}
                                />
                                ...
                                <PDFFormInput
                                    ...
                                    name="work_hours_to"
                                    label="WORK HOURS TO"
                                    defaultValue={initialFormData?.primary_parent_info?.parent_work_hours_to || ''}
                                />

                                <div>
                                    <PDFFormInput
                                        id="business_telephone_number"
                            ...
                            <div className="grid grid-cols-2 gap-6 px-4 sm:px-6 py-6">
                                <PDFFormInput
                                    id="business_cell_number"
                                    name="business_cell_number"
                                    label="CELL NUMBER"
                                    defaultValue={initialFormData?.primary_parent_info?.parent_business_cell_number || ''}
                                />
                                ...
                                <PDFFormInput
                                    ...
                                    label="EMAIL ADDRESS"
                                    defaultValue={initialFormData?.primary_parent_info?.parent_email || ''}
                                />
                    ...
                    >
                        ...
                        <div className="grid grid-cols-2 gap-6 px-4 sm:px-6 py-6">
                            ...
                            <div>
                                ...
                                <PDFFormInput
                                    id="parent_two_home_telephone_number"
                                    name="parent_two_home_telephone_number"
                                    defaultValue={initialFormData?.primary_parent_info?.parent_business_cell_number || ''}
                                />
                            ...
                            <div>
                                ...
                                <PDFFormInput
                                    ...
                                    name="parent_business_street_address"
                                    defaultValue={initialFormData?.primary_parent_info?.parent_street_address || ''}
                                />
                            </div>
                            ...
                            <div>
                                ...
                                <PDFFormInput
                                    id="child_care_provider_city_address"
                        ...
                        <div className="grid grid-cols-3 gap-6 px-4 sm:px-6 py-6">
                            ...
                            <PDFFormInput
                                id="parent_two_business_name"
                                name="parent_two_business_name"
                                label="NAME"
                                defaultValue={initialFormData?.primary_parent_info?.parent_business_name || ''}
                            />

                            <PDFFormInput
                                id="parent_two_work_hours_from"
                                name="parent_two_work_hours_from"
                                label="WORK HOURS FROM"
                                defaultValue={initialFormData?.primary_parent_info.parent_work_hours_from || ''}
                            />

                            <PDFFormInput
                                id="parent_two_work_hours_to"
                                name="parent_two_work_hours_to"
                                label="WORK HOURS TO"
                                defaultValue={initialFormData?.primary_parent_info.parent_work_hours_to || ''}
                            />
                            ...
                            <div>
                                <PDFFormInput
                                    ...
                                    defaultValue={initialFormData?.primary_parent_info?.parent_business_telephone_number || ''}
                                />
                                <span id="parent_two_business_telephone_number_span" style={{ display: 'none' }}>
                                    Enter valid input [only numbers,+,-,()].
                                </span>
                            </div>
                    ...
                    >
                        ...
                        <div className="grid grid-cols-2 gap-6 px-4 sm:px-6 py-6">
                            ...
                            <div>
                                ...
                                <PDFFormInput
                                    id="child_hospital_affiliation"
                                    name="child_hospital_affiliation"
                                    defaultValue={initialFormData?.child_care_provider_info?.child_hospital_affiliation || ''}
                                />
                            </div>
                        </div>
                    ...
                    >
                        ...
                        <div className="grid grid-cols-2 gap-6 px-4 sm:px-6 py-6">
                            <div>
                                ...
                                <PDFFormInput
                                    ...
                                    defaultValue={initialFormData?.child_care_provider_info?.child_care_provider_street_address || ''}
                                />
                            </div>
                            <div>
                                <label htmlFor="child_care_provider_city_address" className="form-label"><b>CITY</b>
                                ...
                                <PDFFormInput
                                    id="child_care_provider_city_address"
                                    name="child_care_provider_city_address"
                                    defaultValue={initialFormData?.child_care_provider_info?.child_care_provider_city_address || ''}
                                />
                            </div>
                        </div>
                        ...
                        <div className="grid grid-cols-3 gap-6 px-4 sm:px-6 py-6">
                            <div>
                                ...
                                <PDFFormInput
                                    id="child_care_provider_state_address"
                                    name="child_care_provider_state_address"
                                    defaultValue={initialFormData?.child_care_provider_info?.child_care_provider_state_address || ''}
                                />
                            </div>
                            ...
                            <div>
                                ...
                                <PDFFormInput
                                    id="child_dentist_name"
                                    name="child_dentist_name"
                                    defaultValue={initialFormData?.child_dentist_name || ''}
                                />
                            </div>
                            ...
                            <div>
                                ...
                                <PDFFormInput
                                    id="allergies_medication_reaction"
                                    name="allergies_medication_reaction"
                                    defaultValue={initialFormData?.allergies_medication_reaction || ''}
                                />
                            </div>
                        </div>
                        ...
                        <div className="grid grid-cols-3 gap-6 px-4 sm:px-6 py-6">
                            ...
                            <div>
                                ...
                                <PDFFormInput
                                    id="dentist_street_address"
                                    name="dentist_street_address"
                                    defaultValue={initialFormData?.dentist_street_address || ''}
                                />
                            </div>
                            ...
                            <div>
                                ...
                                <PDFFormInput
                                    id="dentist_city_address"
                                    name="dentist_city_address"
                                    defaultValue={initialFormData?.dentist_city_address || ''}
                                />
                            </div>
                        ...
                        <div className="grid grid-cols-2 gap-6 px-4 sm:px-6 py-6">
                            <div>
                                ...
                                <PDFFormInput
                                    id="special_diabilities"
                                    name="special_diabilities"
                                    defaultValue={initialFormData?.special_diabilities || ''}
                                />
                            </div>
                            ...
                            <div>
                                ...
                                <PDFFormInput
                                    ...
                                    defaultValue={initialFormData?.additional_info || ''}
                                />
                            </div>
                            ...
                            <div>
                                ...
                                <PDFFormInput
                                    id="policy_number"
                                    name="policy_number"
                                    defaultValue={initialFormData?.policy_number || ''}
                                />
                            </div>
                        </div>
                        <div className="grid grid-cols-1 gap-6 px-4 sm:px-6 pb-6">
                            <div>
                                ...
                                <PDFFormInput
                                    ...
                                    defaultValue={initialFormData?.health_insurance || ''}
                                />
                            </div>
                        </div>
                    ...
                    >
                        ...
                        <div className="grid grid-cols-2 gap-6 px-4 sm:px-6 py-6">
                            <div>
                                ...
                                <PDFFormInput
                                    ...
                                    defaultValue={initialFormData?.obtaining_emergency_medical_care || ''}
                                />
                            </div>
                        ...
                        <div className="grid grid-cols-2 gap-6 px-4 sm:px-6 py-6">
                            ...
                            <div>
                                ...
                                <PDFFormInput
                                    id="dental_exam_last_date"
                                    name="dental_exam_last_date"
                                    type="date"
                                    defaultValue={initialFormData?.dental_exam_last_date || ''}
                                />
                            </div>
                        ...
                        <div className="grid grid-cols-3 gap-6 px-4 sm:px-6 py-6">
                            <div>
                                ...
                                <PDFFormInput
                                    id="allergies"
                                    name="allergies"
                                    defaultValue={initialFormData?.allergies || ''}
                                />
                            </div>
                            <div>
                                ...
                                <PDFFormInput
                                    id="bleeding_problems"
                                    name="bleeding_problems"
                                    defaultValue={initialFormData?.bleeding_problems || ''}
                                />
                            </div>
                            ...
                            <div>
                                ...
                                <PDFFormInput
                                    id="frequent_ear_infections"
                                    name="frequent_ear_infections"
                                    defaultValue={initialFormData?.frequent_ear_infections || ''}
                                />
                            </div>
                            ...
                            <div>
                                ...
                                <PDFFormInput
                                    id="asthma"
                                    name="asthma"
                                    defaultValue={initialFormData?.asthma || ''}
                                />
                            </div>
                            ...
                            <div>
                                ...
                                <PDFFormInput
                                    id="diabetes"
                                    name="diabetes"
                                    defaultValue={initialFormData?.diabetes || ''}
                                />
                            </div>
                            ...
                            <div>
                                ...
                                <PDFFormInput
                                    id="epilepsy"
                                    name="epilepsy"
                                    defaultValue={initialFormData?.epilepsy || ''}
                                />
                            </div>
                        </div>
                    ...
                    >
                        ...
                        <div className="grid grid-cols-3 gap-6 px-4 sm:px-6 py-6">
                            <div>
                                ...
                                <PDFFormInput
                                    id="frequent_illnesses"
                                    name="frequent_illnesses"
                                    defaultValue={initialFormData?.frequent_illnesses || ''}
                                />
                            </div>
                            ...
                            <div>
                                ...
                                <PDFFormInput
                                    id="high_fevers"
                                    name="high_fevers"
                                    defaultValue={initialFormData?.high_fevers || ''}
                                />
                            </div>
                            ...
                            <div>
                                ...
                                <PDFFormInput
                                    ...
                                    defaultValue={initialFormData?.hospitalization || ''}
                                />
                            </div>
                            ...
                            <div>
                                ...
                                <PDFFormInput
                                    ...
                                    defaultValue={initialFormData?.rheumatic_fever || ''}
                                />
                            </div>
                            ...
                            <div>
                                ...
                                <PDFFormInput
                                    ...
                                    name="seizures_convulsions"
                                    defaultValue={initialFormData?.seizures_convulsions || ''}
                                />
                            </div>
                        </div>
                        ...
                        <div className="grid grid-cols-3 gap-6 px-4 sm:px-6 py-6">
                            <div>
                                ...
                                <PDFFormInput
                                    id="serious_injuries_accidents"
                                    name="serious_injuries_accidents"
                                    defaultValue={initialFormData?.serious_injuries_accidents || ''}
                                />
                            </div>
                            ...
                            <div>
                                ...
                                <PDFFormInput
                                    id="surgeries"
                                    name="surgeries"
                                    defaultValue={initialFormData?.surgeries || ''}
                                />
                            </div>
                            ...
                            <div>
                                ...
                                <PDFFormInput
                                    ...
                                    defaultValue={initialFormData?.vision_problems || ''}
                                />
                            </div>
                            ...
                            <div>
                                ...
                                <PDFFormInput
                                    id="medical_other"
                                    name="medical_other"
                                    defaultValue={initialFormData?.medical_other || ''}
                                />
                            </div>
                        </div>
                        ...
                        <div className="grid grid-cols-2 gap-6 px-4 sm:px-6 py-6">
                            <div>
                                ...
                                <PDFFormInput
                                    id="illness_during_pregnancy"
                                    name="illness_during_pregnancy"
                                    defaultValue={initialFormData?.illness_during_pregnancy || ''}
                                />
                            </div>
                            <div>
                                ...
                                <PDFFormInput
                                    id="condition_of_newborn"
                                    name="condition_of_newborn"
                                    defaultValue={initialFormData?.condition_of_newborn || ''}
                                />
                            </div>
                        </div>
                        ...
                        <div className="grid grid-cols-3 gap-6 px-4 sm:px-6 py-6">
                            <div>
                                ...
                                <div className="input-group">
                                    <PDFFormInput
                                        ...
                                        defaultValue={initialFormData?.birth_weight_lbs || ''}
                                    />
                            ...
                            <div>
                                ...
                                <div className="input-group">
                                    <PDFFormInput
                                        ...
                                        defaultValue={initialFormData?.birth_weight_oz || ''}
                                    />
                                    <span className="input-group-text" style={{ backgroundColor: "gray", color: "black", padding: "6px" }}>
                                        oz.
                                    </span>
                            ...
                            <div>
                                ...
                                <PDFFormInput
                                    ...
                                    defaultValue={initialFormData?.duration_of_pregnancy || ''}
                                />
                            </div>
                            <div>
                                ...
                                <PDFFormInput
                                    id="complications"
                                    name="complications"
                                    defaultValue={initialFormData?.complications || ''}
                                />
                            </div>
                            <div>
                                ...
                                <PDFFormInput
                                    id="bottle_fed1"
                                    name="bottle_fed"
                                    defaultValue={initialFormData?.bottle_fed || ''}
                                />
                            </div>
                            ...
                            <div>
                                ...
                                <PDFFormInput
                                    id="breast_fed1"
                                    name="breast_fed"
                                    defaultValue={initialFormData?.breast_fed || ''}
                                />
                            </div>
                        </div>
                        ...
                        <div className="grid grid-cols-2 gap-6 px-4 sm:px-6 py-6">
                            ...
                            <div>
                                ...
                                <PDFFormInput
                                    id="other_siblings_name"
                                    name="other_siblings_name"
                                    defaultValue={initialFormData?.other_siblings_name || ''}
                                />
                            </div>
                            <div>
                                ...
                                <PDFFormInput
                                    id="other_siblings_age"
                                    name="other_siblings_age"
                                    defaultValue={initialFormData?.other_siblings_age || ''}
                                />
                            </div>
                        </div>
                    ...
                    >
                        ...
                        <div className="grid grid-cols-3 gap-6 px-4 sm:px-6 py-6">
                            ...
                            <div>
                                <input type="checkbox" className="input-checkbox custom-checkbox"
                                    ...
                                    checked={checkboxStates.family_history_epilepsy}
                                    onChange={(e) => setCheckboxStates(prev => ({ ...prev, family_history_epilepsy: e.target.checked }))} />
                                <label className="font-bold form-check-label pl-3"
                        ...
                        <div className="grid grid-cols-2 gap-6 px-4 sm:px-6 py-6">
                            <div>
                                ...
                                <PDFFormInput
                                    id="age_group_friends"
                                    name="age_group_friends"
                                    defaultValue={initialFormData?.age_group_friends || ''}
                                />
                            </div>
                            <div>
                                ...
                                <PDFFormInput
                                    id="neighborhood_friends"
                                    name="neighborhood_friends"
                                    defaultValue={initialFormData?.neighborhood_friends || ''}
                                />
                            </div>
                            <div>
                                ...
                                <PDFFormInput
                                    id="relationship_with_mother"
                                    name="relationship_with_mother"
                                    defaultValue={initialFormData?.relationship_with_mother || ''}
                                />
                            </div>
                            <div>
                                ...
                                <PDFFormInput
                                    id="relationship_with_father"
                                    name="relationship_with_father"
                                    defaultValue={initialFormData?.relationship_with_father || ''}
                                />
                            </div>
                            <div>
                                ...
                                <PDFFormInput
                                    ...
                                    defaultValue={initialFormData?.relationship_with_siblings || ''}
                                />
                            </div>
                            <div>
                                ...
                                <PDFFormInput
                                    ...
                                    defaultValue={initialFormData?.relationship_with_extended_family || ''}
                                />
                            </div>
                            ...
                            <div>
                                ...
                                <PDFFormInput
                                    ...
                                    defaultValue={initialFormData?.fears_conflicts || ''}
                                />
                            </div>
                            <div>
                                ...
                                <PDFFormInput
                                    id="child_response_frustration"
                                    name="child_response_frustration"
                                    defaultValue={initialFormData?.child_response_frustration || ''}
                                />
                            </div>
                        </div>
                    ...
                    >
                        ...
                        <div className="grid grid-cols-3 gap-6 px-4 sm:px-6 py-6">
                            <div>
                                ...
                                <PDFFormInput
                                    ...
                                    defaultValue={initialFormData?.favorite_activities || ''}
                                />
                            </div>
                        </div>
                        ...
                        <div className="grid grid-cols-1 gap-6 px-4 sm:px-6 py-6">
                            ...
                            <div>
                                ...
                                <PDFFormInput
                                    id="things_used_at_home"
                                    name="things_used_at_home"
                                    defaultValue={initialFormData?.things_used_at_home || ''}
                                />
                            </div>
                            ...
                            <div>
                                ...
                                <PDFFormInput
                                    id="hours_of_television_daily"
                                    name="hours_of_television_daily"
                                    defaultValue={initialFormData?.hours_of_television_daily || ''}
                                />
                            </div>
                            ...
                            <div>
                                ...
                                <PDFFormInput
                                    id="language_used_at_home"
                                    name="language_used_at_home"
                                    defaultValue={initialFormData?.language_used_at_home || ''}
                                />
                            </div>
                            ...
                            <div>
                                ...
                                <PDFFormInput
                                    id="changes_at_home_situation"
                                    name="changes_at_home_situation"
                                    defaultValue={initialFormData?.changes_at_home_situation || ''}
                                />
                            </div>
                            ...
                            <div>
                                ...
                                <PDFFormInput
                                    ...
                                    defaultValue={initialFormData?.educational_expectations_of_child || ''}
                                />
                            </div>
                            ...
                            <div className="p-4 mb-3">
                                ...
                                <div className="grid grid-cols-1 gap-6 px-4 sm:px-6 py-6">
                                    ...
                                    <PDFFormInput
                                        ...
                                        label="Other important Family Members (Siblings, Grandparent, Pets, etc)"
                                    ...
                                    <PDFFormInput
                                        ...
                                        label="Tell us about your family traditions or important celebrations"
                        ...
                        <div className="grid grid-cols-2 gap-6 px-4 sm:px-6 py-6">
                            <div>
                                ...
                                <PDFFormInput
                                    ...
                                    name="reason_for_childcare_before"
                                    defaultValue={initialFormData?.reason_for_childcare_before || ''}
                                />
                            </div>
                            ...
                            <div>
                                ...
                                <PDFFormInput
                                    ...
                                    defaultValue={initialFormData?.what_child_interests || ''}
                                />
                            </div>
                                ...
                                <div className="p-4">
                                    ...
                                    <div className="form-group text-center mt-4">
                                        <PDFFormInput
                                            ...
                                            defaultValue={initialFormData?.photo_usage_photo_video_permission_form || ''}
                                        />
                                    </div>
                                </div>
                            </div>
