...
const AdmissionSection = forwardRef(({ initialFormData }, ref) => {
  console.log('AdmissionSection - initialFormData:', initialFormData);
  ...
  const [checkboxStates, setCheckboxStates] = useState({
    agree_all_above_info_is_correct: false,
    agree_all_above_information_is_correct: false,
    approve_social_media_post: false,
    do_you_agree_this: false,
    do_you_agree_this_health_policies: false,
    do_you_agree_this_immunization_instructions: false,
    do_you_agree_this_photo_video_permission_form: false,
    do_you_agree_this_pick_up_password_form: false,
    do_you_agree_this_social_media_post: false,
    medical_transportation_waiver: false,
    no_illnesses_for_this_child: false,
    parent_sign_outside_waiver: false,
    photo_permission_agree_group_photos_electronic: false,
    security_release_policy_form: false,
    family_history_asthma: false,
    family_history_allergies: false,
    family_history_diabetes: false,
    family_history_epilepsy: false,
    family_history_heart_problems: false,
    family_history_high_blood_pressure: false,
    family_history_hyperactivity: false,
    family_history_tuberculosis: false,
    family_history_vision_problems: false
  });
  ...
  const section20Ref = useRef();
  // ✅ Enhance styling for PDF rendering
  // ✅ Enhance styles before capture
  const enhanceElementForPDF = (element) => {
    ...
    allElements.forEach((el) => {
      ...
      if (style.backgroundColor === "transparent") el.style.backgroundColor = "#ffffff";
      if (style.color === "transparent") el.style.color = "#000000";
  ...
  const generatePDF = async (isPrint = false) => {
    try {
      ...
      const sections = [
        ...
        section17Ref, section18Ref, section19Ref, section20Ref,
      ];

      for (let i = 0; i < sections.length; i += 2) {
        const s1 = sections[i].current;
        const s2 = sections[i + 1]?.current;

        if (!s1) break;

        const img1 = (await captureSection(s1)).toDataURL("image/jpeg", 0.9);
        const img2 = s2 ? (await captureSection(s2)).toDataURL("image/jpeg", 0.9) : null;
        ...
        if (img2) pdf.addImage(img2, "JPEG", margin, margin * 2 + halfHeight, imgWidth, halfHeight);
      }
  ...
  useImperativeHandle(ref, () => ({
    handleDownload2: () => generatePDF(false),
    handlePrint2: () => generatePDF(true),
    section1Ref, section2Ref, section3Ref, section4Ref,
    section5Ref, section6Ref, section7Ref, section8Ref,
    section9Ref, section10Ref, section11Ref, section12Ref,
    section13Ref, section14Ref, section15Ref, section16Ref,
    ...
    <>
      ...
      <div id="pdf-wrapper" className="w-full">
        ...
        <div className="min-h-screen p-4 sm:p-6" >
          ...
          >
            {/* Header Section */}
            <PDFHeader heading={"APPLICATION FOR ADMISSION"} />

            {/* Form Fields */}
            <div className="px-4 sm:px-6">
              <div className="grid grid-cols-3 gap-6 px-4 sm:px-6 py-6">
                <div>
                  ...
                  <input
                    ...
                    type="text"
                    maxLength={40}
                    className="form-control text-box w-full border-b mt-3 text-[20px] focus:border-transparent" style={{ lineHeight: "1.5", minHeight: "40px" }}
                    id="child_first_name"
                ...
                <div>
                  ...
                  <input
                    ...
                    className="form-control text-box w-full border-b mt-3 text-[20px] focus:border-transparent" style={{ lineHeight: "1.5", minHeight: "40px" }}
                    id="dob"
                    defaultValue={initialFormData?.dob || ''}
                  />
                ...
                <div>
                  ...
                  <input type="text" className="form-control text-box w-full border-b mt-3 text-[20px] focus:border-transparent" style={{ lineHeight: "1.5", minHeight: "40px" }} aria-label="Telephone Number"
                ...
                <div>
                  ...
                  <input
                    ...
                    id="gender"
                    defaultValue={
                      initialFormData?.gender === '1' || initialFormData?.child_gender === '1'
                        ? "Male"
                        : initialFormData?.gender === '2' || initialFormData?.child_gender === '2'
                          ? "Female"
                          : initialFormData?.gender === '3' || initialFormData?.child_gender === '3'
                            ? "Others"
                            : ""
                    }
                  />
              ...
              <div className="grid grid-cols-2 gap-6 px-4 sm:px-6 py-6">
                <div>
                  ...
                  <input type="text" className="form-control text-box w-full border-b mt-3 text-[20px] focus:border-transparent" style={{ lineHeight: "1.5", minHeight: "40px" }} id="school_age_child_school"
                ...
                <div>
                  ...
                  <input type="text" className="form-control text-box w-full border-b px-2 py-1  " id="parent_name" defaultValue={initialFormData?.primary_parent_info?.parent_name || ''}
                ...
                <div>
                  ...
                  <input type="text" className="form-control text-box w-full border-b px-2 py-1 "
                    ...
                    id="do_relevant_custody_papers_apply1" defaultValue={initialFormData?.do_relevant_custody_papers_apply || ''}></input>
                </div>

                <div>
                  <label htmlFor="parent_street_address" className="form-label"><b>STREET</b>
                  </label><br />
                  <input type="text" className="form-control text-box w-full border-b mt-3 text-[20px] focus:border-transparent" style={{ lineHeight: "1.5", minHeight: "40px" }} id="parent_street_address"
                ...
                <div>
                  ...
                  <input type="text" className="form-control text-box w-full border-b mt-3 text-[20px] focus:border-transparent" style={{ lineHeight: "1.5", minHeight: "40px" }} id="parent_city_address" defaultValue={initialFormData?.primary_parent_info?.parent_city_address || ''}
              ...
              <div className="grid grid-cols-3 gap-6 px-4 sm:px-6 py-6">
                <div> <label htmlFor="business_name" className="form-label"><b>NAME</b>
                  ...
                  <input type="text" className="form-control text-box w-full border-b px-2 py-1 " id="business_name"
                    name="business_name" defaultValue={initialFormData?.primary_parent_info?.parent_business_name || ''} />
                ...
                <div>
                  ...
                  <input type="text" className="form-control text-box w-full border-b px-2 py-1 " id="parent_state_address"
                    name="parent_state_address" defaultValue={initialFormData?.primary_parent_info?.parent_state_address || ''}></input>
                </div>
                ...
                <div>
                  ...
                  <input type="text" className="form-control text-box w-full border-b px-2 py-1 " id="parent_zip_address"
                    name="parent_zip_address" defaultValue={initialFormData?.primary_parent_info?.parent_zip_address || ''}
                  />
                ...
                <div>
                  ...
                  <input type="text" className="form-control text-box w-full border-b mt-3 text-[20px] focus:border-transparent" style={{ lineHeight: "1.5", minHeight: "40px" }} id="work_hours_from"
                ...
                <div>
                  ...
                  <input type="text" className="form-control text-box w-full border-b mt-3 text-[20px] focus:border-transparent" style={{ lineHeight: "1.5", minHeight: "40px" }} id="work_hours_to"
                ...
                <div>
                  ...
                  <input type="text" className="form-control text-box w-full border-b mt-3 text-[20px] focus:border-transparent" style={{ lineHeight: "1.5", minHeight: "40px" }} id="business_telephone_number"
              ...
              <div className="grid grid-cols-2 gap-6 px-4 sm:px-6 py-6">
                ...
                <div>
                  ...
                  <input type="text" className="form-control text-box w-full border-b mt-3 text-[20px] focus:border-transparent" style={{ lineHeight: "1.5", minHeight: "40px" }} id="primary_parent_email"
          ...
          >
            ...
            <div className="grid grid-cols-2 gap-6 px-4 sm:px-6 py-6">
              <div>
                ...
                <input type="text" className="form-control text-box w-full border-b mt-3 text-[20px] focus:border-transparent" style={{ lineHeight: "1.5", minHeight: "40px" }} id="parent_two_name"
                  name="parent_two_name" defaultValue={initialFormData?.primary_parent_info?.parent_name || ''}></input>
              </div>
              <div>
                ...
                <input type="text" className="form-control text-box w-full border-b mt-3 text-[20px] focus:border-transparent" style={{ lineHeight: "1.5", minHeight: "40px" }} aria-label="Telephone Number"
                  id="parent_two_home_telephone_number" name="parent_two_home_telephone_number" defaultValue={initialFormData?.primary_parent_info?.parent_business_cell_number || ''}
                />
                <span id="parent_two_home_telephone_number_span" style={{ display: 'none' }}>
                  Enter valid input [only numbers,+,-,()].</span>
              </div>
              <div>
                <label htmlFor="parent_business_street_address" className="form-label"><b>STREET</b>
                </label><br />
                <input type="text" className="form-control text-box w-full border-b mt-3 text-[20px] focus:border-transparent" style={{ lineHeight: "1.5", minHeight: "40px" }}
                  id="parent_business_street_address"
                  name="parent_business_street_address" defaultValue={initialFormData?.primary_parent_info?.parent_street_address || ''} ></input>
              </div>
              ...
              <div>
                ...
                <input type="text" className="form-control text-box w-full border-b mt-3 text-[20px] focus:border-transparent" style={{ lineHeight: "1.5", minHeight: "40px" }}
                  id="child_care_provider_city_address" name="child_care_provider_city_address" defaultValue={initialFormData?.primary_parent_info?.parent_city_address || ''}></input>
              </div>
            ...
            <div className="grid grid-cols-3 gap-6 px-4 sm:px-6 py-6">
              <div>
                ...
                <input type="text" className="form-control text-box w-full border-b mt-3 text-[20px] focus:border-transparent" style={{ lineHeight: "1.5", minHeight: "40px" }}
                  id="child_care_provider_state_address" name="child_care_provider_state_address" defaultValue={initialFormData?.primary_parent_info?.parent_state_address || ''}></input>
              </div>
              ...
              <div>
                ...
                <input type="text" className="form-control text-box w-full border-b mt-3 text-[20px] focus:border-transparent" style={{ lineHeight: "1.5", minHeight: "40px" }}
                  id="child_care_provider_zip_address" name="child_care_provider_zip_address" defaultValue={initialFormData?.primary_parent_info?.parent_zip_address || ''}
                />
              ...
              <div>
                ...
                <input type="text" className="form-control text-box w-full border-b mt-3 text-[20px] focus:border-transparent" style={{ lineHeight: "1.5", minHeight: "40px" }} id="parent_two_business_name"
                  name="parent_two_business_name" defaultValue={initialFormData?.primary_parent_info?.parent_business_name || ''}></input>
              </div>
              ...
              <div>
                ...
                <input type="text" className="form-control text-box w-full border-b mt-3 text-[20px] focus:border-transparent" style={{ lineHeight: "1.5", minHeight: "40px" }} id="parent_two_work_hours_from"
                  name="parent_two_work_hours_from" defaultValue={initialFormData?.primary_parent_info.parent_work_hours_from || ''}></input>
              </div>

              <div>
                <label htmlFor="parent_two_work_hours_to" className="form-label"><b>WORK HOURS TO</b>
                </label><br />
                <input type="text" className="form-control text-box w-full border-b mt-3 text-[20px] focus:border-transparent" style={{ lineHeight: "1.5", minHeight: "40px" }} id="parent_two_work_hours_to"
                  name="parent_two_work_hours_to" defaultValue={initialFormData?.primary_parent_info.parent_work_hours_to || ''}></input>
              </div>
              ...
              <div>
                ...
                <input type="text" className="form-control text-box w-full border-b mt-3 text-[20px] focus:border-transparent" style={{ lineHeight: "1.5", minHeight: "40px" }}
                  ...
                  defaultValue={initialFormData?.primary_parent_info?.parent_business_telephone_number || ''}
            ...
            <div className="grid grid-cols-2 gap-6 px-4 sm:px-6 py-6">
              <div>
                ...
                <input type="text" className="form-control text-box w-full border-b mt-3 text-[20px] focus:border-transparent" style={{ lineHeight: "1.5", minHeight: "40px" }} aria-label="Telephone Number"
                  id="business_cell_number" name="business_cell_number"
                  defaultValue={initialFormData?.primary_parent_info?.parent_business_telephone_number || ''}
                ></input>
              </div>
            ...
            <div className="grid grid-cols-2 gap-6 px-4 sm:px-6 py-6">
              <div>
                ...
                <input type="text" className="form-control text-box w-full border-b mt-3 text-[20px] focus:border-transparent" style={{ lineHeight: "1.5", minHeight: "40px" }} aria-label="Emergency Name"
          ...
          >
            ...
            <div className="grid grid-cols-3 gap-6 px-4 sm:px-6 py-6">
              <div>
                ...
                <input type="text" className="form-control text-box w-full border-b mt-3 text-[20px] focus:border-transparent" style={{ lineHeight: "1.5", minHeight: "40px" }} aria-label="Emergency Relationship"
              ...
              <div>
                ...
                <input type="text" className="form-control text-box w-full border-b mt-3 text-[20px] focus:border-transparent" style={{ lineHeight: "1.5", minHeight: "40px" }} aria-label="emergency_address"
            ...
            <h5 className="pl-5 text-black text-[1.25rem]">Emergency Contact 3:</h5>
            <div className="grid grid-cols-2 gap-6 px-4 sm:px-6 py-6">
              <div>
            ...
            <div className="grid grid-cols-3 gap-6 px-4 pb-6 sm:px-6 ">
              <div>
            ...
            <div className="grid grid-cols-2 gap-6 px-4 sm:px-6 py-6">
              <div>
                ...
                <input type="text" className="form-control text-box w-full border-b mt-3 text-[20px] focus:border-transparent" style={{ lineHeight: "1.5", minHeight: "40px" }} id="child_care_provider_name"
              ...
              <div>
                ...
                <input type="text" className="form-control text-box w-full border-b mt-3 text-[20px] focus:border-transparent" style={{ lineHeight: "1.5", minHeight: "40px" }} id="child_hospital_affiliation"
          ...
          >
            ...
            <div className="grid grid-cols-3 gap-6 px-4 sm:px-6 py-6">
              ...
              <div>
                ...
                <input type="text" className="form-control text-box w-full border-b mt-3 text-[20px] focus:border-transparent" style={{ lineHeight: "1.5", minHeight: "40px" }} id="child_dentist_name"
              ...
              <div>
                ...
                <input type="text" className="form-control text-box w-full border-b mt-3 text-[20px] focus:border-transparent" style={{ lineHeight: "1.5", minHeight: "40px" }} id="dentist_telephone_number"
              ...
              <div>
                ...
                <input type="text" className="form-control text-box w-full border-b mt-3 text-[20px] focus:border-transparent" style={{ lineHeight: "1.5", minHeight: "40px" }} id="allergies_medication_reaction"
            ...
            <div className="grid grid-cols-3 gap-6 px-4 sm:px-6 py-6">
              ...
              <div>
                ...
                <input type="text" className="form-control text-box w-full border-b mt-3 text-[20px] focus:border-transparent" style={{ lineHeight: "1.5", minHeight: "40px" }} id="dentist_street_address"
              ...
              <div>
                ...
                <input type="text" className="form-control text-box w-full border-b mt-3 text-[20px] focus:border-transparent" style={{ lineHeight: "1.5", minHeight: "40px" }} id="dentist_city_address"
              ...
              <div>
                ...
                <input type="text" className="form-control text-box w-full border-b mt-3 text-[20px] focus:border-transparent" style={{ lineHeight: "1.5", minHeight: "40px" }} id="dentist_state_address"
              ...
              <div>
                ...
                <input type="text" className="form-control text-box w-full border-b mt-3 text-[20px] focus:border-transparent" style={{ lineHeight: "1.5", minHeight: "40px" }} id="dentist_zip_address"
            ...
            <div className="grid grid-cols-2 gap-6 px-4 sm:px-6 py-6">
              <div>
                ...
                <input type="text" className="form-control text-box w-full border-b mt-3 text-[20px] focus:border-transparent" style={{ lineHeight: "1.5", minHeight: "40px" }} id="special_diabilities"
              ...
              <div>
                ...
                <input type="text" className="form-control text-box w-full border-b mt-3 text-[20px] focus:border-transparent" style={{ lineHeight: "1.5", minHeight: "40px" }} id="medication" name="medication"></input>
              </div>
              ...
              <div>
                ...
                <input type="text" className="form-control text-box w-full border-b mt-3 text-[20px] focus:border-transparent" style={{ lineHeight: "1.5", minHeight: "40px" }} id="additional_info"
              ...
              <div>
                ...
                <input type="text" className="form-control text-box w-full border-b mt-3 text-[20px] focus:border-transparent" style={{ lineHeight: "1.5", minHeight: "40px" }} id="policy_number"
                  name="policy_number"
                  defaultValue={initialFormData?.policy_number || ''}></input>
              </div>
            </div>
            <div className="grid grid-cols-1 gap-6 px-4 sm:px-6 pb-6">
              <div>
                ...
                <input type="text" className="form-control text-box w-full border-b mt-3 text-[20px] focus:border-transparent" style={{ lineHeight: "1.5", minHeight: "40px" }} id="health_insurance"
          ...
          >
            ...
            <div className="form-group flex align-items-center gap-4 px-4 sm:px-6">
              <input type="checkbox" className="input-checkbox custom-checkbox"
                ...
                checked={checkboxStates.agree_all_above_information_is_correct}
                onChange={(e) => setCheckboxStates(prev => ({ ...prev, agree_all_above_information_is_correct: e.target.checked }))} />
              <label className="font-bold form-check-label" htmlFor="agree_all_above_information_is_correct">
            ...
            <div className="grid grid-cols-2 gap-6 px-4 sm:px-6 py-6">
              <div>
                ...
                <input type="date" className="form-control text-box w-full border-b mt-3 text-[20px] focus:border-transparent" style={{ lineHeight: "1.5", minHeight: "40px" }} id="physical_exam_last_date"
              ...
              <div>
                ...
                <input type="date" className="form-control text-box w-full border-b mt-3 text-[20px] focus:border-transparent" style={{ lineHeight: "1.5", minHeight: "40px" }} id="dental_exam_last_date"
            ...
            <div className="grid grid-cols-3 gap-6 px-4 sm:px-6 py-6">
              ...
              <div>
                ...
                <input type="text" className="form-control text-box w-full border-b mt-3 text-[20px] focus:border-transparent" style={{ lineHeight: "1.5", minHeight: "40px" }} name="bleeding_problems"
              ...
              <div>
                ...
                <input type="text" className="form-control text-box w-full border-b mt-3 text-[20px] focus:border-transparent" style={{ lineHeight: "1.5", minHeight: "40px" }} id="frequent_ear_infections"
              ...
              <div>
                ...
                <input type="text" className="form-control text-box w-full border-b mt-3 text-[20px] focus:border-transparent" style={{ lineHeight: "1.5", minHeight: "40px" }} id="asthma" name="asthma" defaultValue={initialFormData?.asthma || ''}></input>
              </div>

              <div>
                <label htmlFor="diabetes" className="form-label"><b>Diabetes</b>
                </label><br />
                <input type="text" className="form-control text-box w-full border-b mt-3 text-[20px] focus:border-transparent" style={{ lineHeight: "1.5", minHeight: "40px" }} id="diabetes" name="diabetes" defaultValue={initialFormData?.diabetes || ''}></input>
              </div>

              <div>
                <label htmlFor="epilepsy" className="form-label"><b>Epilepsy</b>
                </label><br />
                <input type="text" className="form-control text-box w-full border-b mt-3 text-[20px] focus:border-transparent" style={{ lineHeight: "1.5", minHeight: "40px" }} id="epilepsy" name="epilepsy" defaultValue={initialFormData?.epilepsy || ''}></input>
              </div>
            </div>
            ...
            <div className="grid grid-cols-3 gap-6 px-4 sm:px-6 py-6">
              <div>
                ...
                <input type="text" className="form-control text-box w-full border-b px-2 py-1 focus:border-transparent" id="frequent_illnesses"
                  name="frequent_illnesses" defaultValue={initialFormData?.frequent_illnesses || ''}></input>
              </div>
              ...
              <div>
                ...
                <input type="text" className="form-control text-box w-full border-b px-2 py-1 focus:border-transparent" id="hearing_problems"
                  name="hearing_problems" defaultValue={initialFormData?.frequent_ear_infections || ''}></input>
              </div>
              ...
              <div>
                ...
                <input type="text" className="form-control text-box w-full border-b px-2 py-1 focus:border-transparent" id="high_fevers"
                  name="high_fevers" defaultValue={initialFormData?.high_fevers || ''}></input>
              </div>
              ...
              <div>
                ...
                <input type="text" className="form-control text-box w-full border-b px-2 py-1 focus:border-transparent" id="hospitalization"
                  name="hospitalization" defaultValue={initialFormData?.hospitalization || ''}></input>
              </div>
              ...
              <div>
                ...
                <input type="text" className="form-control text-box w-full border-b px-2 py-1 focus:border-transparent" id="rheumatic_fever"
                  name="rheumatic_fever" defaultValue={initialFormData?.rheumatic_fever || ''}></input>
              </div>
              ...
              <div>
                ...
                <input type="text" className="form-control text-box w-full border-b px-2 py-1 focus:border-transparent" id="seizures_convulsions"
                  name="seizures_convulsions" defaultValue={initialFormData?.seizures_convulsions || ''}></input>
              </div>
            </div>
            ...
            <div className="grid grid-cols-3 gap-6 px-4 sm:px-6 py-6">
              <div>
                ...
                <input type="text" className="form-control text-box w-full border-b px-2 py-1 focus:border-transparent" id="serious_injuries_accidents"
                  name="serious_injuries_accidents" defaultValue={initialFormData?.serious_injuries_accidents || ''}></input>
              </div>

              <div>
                <label htmlFor="surgeries" className="form-label"><b>Surgeries</b>
                </label><br />
                <input type="text" className="form-control text-box w-full border-b px-2 py-1 focus:border-transparent" id="surgeries" name="surgeries" defaultValue={initialFormData?.surgeries || ''}></input>
              </div>
              ...
              <div>
                ...
                <input type="text" className="form-control text-box w-full border-b px-2 py-1 focus:border-transparent" id="vision_problems"
                  name="vision_problems" defaultValue={initialFormData?.vision_problems || ''}></input>
              </div>
              ...
              <div>
                ...
                <input type="text" className="form-control text-box w-full border-b px-2 py-1 focus:border-transparent" id="medical_other"
                  name="medical_other" defaultValue={initialFormData?.medical_other || ''}></input>
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-6 px-4 sm:px-6 py-6">
              <div>
                ...
                <input type="text" className="form-control text-box w-full border-b px-2 py-1 focus:border-transparent" id="illness_during_pregnancy"
                  name="illness_during_pregnancy" defaultValue={initialFormData?.illness_during_pregnancy || ''}></input>
              </div>
              <div>
                ...
                <input type="text" className="form-control text-box w-full border-b px-2 py-1 focus:border-transparent" id="condition_of_newborn"
                  name="condition_of_newborn" defaultValue={initialFormData?.condition_of_newborn || ''}></input>
              </div>
            </div>
            ...
            <div className="grid grid-cols-3 gap-6 px-4 sm:px-6 py-6">
              <div>
                ...
                <div className="input-group">
                  <input
                    ...
                    id="birth_weight_lbs"
                    name="birth_weight_lbs" defaultValue={initialFormData?.birth_weight_lbs || ''}
                  />
              ...
              <div>
                ...
                <div className="input-group">
                  <input
                    type="text"
                    className="form-control text-box border-b px-2 py-1 w-60 focus:border-transparent"
                    id="birth_weight_oz"
                    name="birth_weight_oz" defaultValue={initialFormData?.birth_weight_oz || ''}
                  />
                  <span className="input-group-text" style={{ backgroundColor: "gray", color: "black", padding: "6px" }}>
                    oz.
                  </span>
              ...
              <div>
                ...
                <input type="text" className="form-control text-box w-full border-b px-2 py-1 focus:border-transparent" id="duration_of_pregnancy"
                  name="duration_of_pregnancy" defaultValue={initialFormData?.duration_of_pregnancy || ''}></input>
              </div>
              <div>
                ...
                <input type="text" className="form-control text-box w-full border-b px-2 py-1 focus:border-transparent" id="complications"
                  name="complications" defaultValue={initialFormData?.complications || ''}></input>
              </div>
              <div>
                <label htmlFor="bottle_fed" className="form-label"><b>Bottle Fed?</b>
                </label><br />
                <input name="bottle_fed" id="bottle_fed1" className="form-control text-box w-full border-b px-2 py-1 focus:border-transparent" defaultValue={initialFormData?.bottle_fed || ''}></input>
              </div>

              <div>
                <label htmlFor="breast_fed" className="form-label"><b>Breast Fed?</b>
                </label><br />
                <input name="breast_fed" id="breast_fed1" className="form-control text-box w-full border-b px-2 py-1 focus:border-transparent" defaultValue={initialFormData?.breast_fed || ''}></input>
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-6 px-4 sm:px-6 py-6">
              ...
              <div>
                ...
                <input type="text" className="form-control text-box w-full border-b px-2 py-1 focus:border-transparent" id="other_siblings_name"
                  name="other_siblings_name" defaultValue={initialFormData?.other_siblings_name || ''}></input>
              </div>
              <div>
                ...
                <input type="text" className="form-control text-box w-full border-b px-2 py-1 focus:border-transparent" id="other_siblings_age"
                  name="other_siblings_age" defaultValue={initialFormData?.other_siblings_age || ''}></input>
              </div>
            </div>
            ...
            <div className="grid grid-cols-3 gap-6 px-4 sm:px-6 py-6">
              <div>
                <input type="checkbox" className="input-checkbox custom-checkbox"
                  ...
                  checked={checkboxStates.family_history_allergies}
                  onChange={(e) => setCheckboxStates(prev => ({ ...prev, family_history_allergies: e.target.checked }))} />
                <label className="font-bold form-check-label pl-3"
                  htmlFor="family_history_allergies">Allergies
                </label>
              </div>
              <div>
                <input type="checkbox" className="input-checkbox custom-checkbox"
                  id="family_history_heart_problems" name="family_history_heart_problems"
                  checked={checkboxStates.family_history_heart_problems}
                  onChange={(e) => setCheckboxStates(prev => ({ ...prev, family_history_heart_problems: e.target.checked }))} />
                <label className="font-bold form-check-label pl-3" htmlFor="family_history_heart_problems">Heart
                  Problems
                </label>
              </div>
              ...
              <div>
                <input type="checkbox" className="input-checkbox custom-checkbox"
                  ...
                  checked={checkboxStates.family_history_tuberculosis}
                  onChange={(e) => setCheckboxStates(prev => ({ ...prev, family_history_tuberculosis: e.target.checked }))} />
                <label className="font-bold form-check-label pl-3"
                  htmlFor="family_history_tuberculosis">Tuberculosis
                </label>
              </div>
              ...
              <div>
                <input
                  ...
                  id="family_history_asthma"
                  name="family_history_asthma"
                  checked={checkboxStates.family_history_asthma}
                  onChange={(e) => setCheckboxStates(prev => ({ ...prev, family_history_asthma: e.target.checked }))}
                />
                <label className="font-bold form-check-label pl-3" htmlFor="family_history_asthma">Asthma
                </label>
              </div>
              <div>
                <input type="checkbox" className="input-checkbox custom-checkbox"
                  id="family_history_vision_problems" name="family_history_vision_problems"
                  checked={checkboxStates.family_history_vision_problems}
                  onChange={(e) => setCheckboxStates(prev => ({ ...prev, family_history_vision_problems: e.target.checked }))} />
                <label className="font-bold form-check-label pl-3" htmlFor="family_history_vision_problems">Vision
                  Problems
                </label>
              </div>
              <div>
                <input type="checkbox" className="input-checkbox custom-checkbox"
                  ...
                  checked={checkboxStates.family_history_diabetes}
                  onChange={(e) => setCheckboxStates(prev => ({ ...prev, family_history_diabetes: e.target.checked }))} />
                <label className="font-bold form-check-label pl-3"
                  htmlFor="family_history_diabetes">Diabetes
                </label>
              </div>
              ...
              <div>
                <input type="checkbox" className="input-checkbox custom-checkbox"
                  ...
                  checked={checkboxStates.family_history_high_blood_pressure}
                  onChange={(e) => setCheckboxStates(prev => ({ ...prev, family_history_high_blood_pressure: e.target.checked }))} />
                <label className="font-bold form-check-label pl-3" htmlFor="family_history_high_blood_pressure">High
                  Blood Pressure
                </label>
              </div>
              ...
              <div>
                <input type="checkbox" className="input-checkbox custom-checkbox"
                  ...
                  checked={checkboxStates.family_history_hyperactivity}
                  onChange={(e) => setCheckboxStates(prev => ({ ...prev, family_history_hyperactivity: e.target.checked }))} />
                <label className="font-bold form-check-label pl-3"
                  htmlFor="family_history_hyperactivity">Hyperactivity
                </label>
              </div>
              ...
              <div>
                <input type="checkbox" className="input-checkbox custom-checkbox"
                  ...
                  checked={checkboxStates.no_illnesses_for_this_child}
                  onChange={(e) => setCheckboxStates(prev => ({ ...prev, no_illnesses_for_this_child: e.target.checked }))} />
                <label className="font-bold form-check-label pl-3" htmlFor="no_illnesses_for_this_child">No
                  Illnesses
                </label>
              </div>
              ...
              <div>
                ...
                <label className="font-bold form-check-label pl-3"
                  htmlFor="family_history_epilepsy">Epilepsy
                </label>
              </div>
            </div>
          ...
          >
            ...
            <div className="grid grid-cols-1 gap-6 px-4 sm:px-6 py-6">
              ...
              <div className="form-group flex align-items-center gap-1">
                ...
                <label className="font-bold form-check-label pl-3" htmlFor="agree_all_above_info_is_correct">
                  I agree all the above information is correct.
                </label>
              </div>
          ...
          >
            ...
            <div className="pt-4">
              <div className="p-4 mb-3">
                ...
                <div className="form-group flex align-items-center gap-1 pl-[1%] pt-[20px]">
                  <input
                    type="checkbox"
                    className="input-checkbox custom-checkbox"
                  ...
                  />
                  <label className="font-bold form-check-label pl-3" htmlFor="do_you_agree_this_immunization_instructions">
          ...
          >
            ...
            <div className="grid grid-cols-1 gap-6 px-4 sm:px-6 py-6 mb-5">
              ...
              <div className="form-group flex align-items-center gap-1 mb-3">
                <input
                  type="checkbox"
                  className="input-checkbox custom-checkbox"
                ...
                />
                <label className="font-bold form-check-label pl-3" htmlFor="do_you_agree_this">
                  <span>
            ...
            <div className="grid grid-cols-1 gap-6 px-4 sm:px-6 py-6">
              ...
              <div className="pt-4">
                <div className="p-4">
                  ...
                  <div className="form-group flex align-items-center gap-1 mt-4">
                    <input
                      type="checkbox"
                      className="input-checkbox custom-checkbox"
                    ...
                    />
                    <label
                      className="font-bold form-check-label pl-3"
            ...
            <div className="grid grid-cols-1 gap-6 px-4 sm:px-6 py-6">
              ...
              <div className="m-2">
                <div className="form-group flex items-center gap-2">
                  ...
                  />
                  <label
                    className="font-bold form-check-label"
            ...
            <div className="grid grid-cols-1 gap-6 px-4 sm:px-6 py-6">
              ...
              <div className="m-2 mb-3">
                <div className="form-group flex items-center gap-2">
                  ...
                  >
                    I agree Security Release &amp; Policy Acknowledgement.
                  </label>
                </div>
              </div>
              ...
              <div className="m-4">
                ...
                <div className="form-group flex items-center gap-2 mt-3">
                  ...
                  >
                    I agree medical transportation waiver.
                  </label>
                </div>
              </div>
