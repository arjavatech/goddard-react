...
const TheGoddardSchool = ({ fieldValue, openSection, setOpenSection, handleChange: parentHandleChange }) => {
  ...
  const handleChange = (e) => {
    ...
    const headerClasses = `
    rounded-t-lg border px-6 py-4 flex items-center justify-between cursor-pointer
        ...
        <>
            ...
            {isOpen && (
                <div className="border p-6 space-y-6 bg-gray-50" onClick={(e) => e.stopPropagation()}>
                    ...
                    >
                        <h1 className="text-2xl font-bold mb-4 text-center mb-10 max-sm:text-[16px]">
                        ...
                        <p className="mt-13">The Goddard School® philosophy is to provide an atmosphere suited to the development of selfesteem, confidence, and love of learning. By combining the best possible equipment and
                        ...
                        <p className="mt-13">The educational goal of The Goddard School® is to utilize fun and creativity to foster a love
                        ...
                        <p className="mt-13">You, the parent, are very important to The Goddard staff because you know your child best. We
                        ...
                        <p className="mt-13">We are looking forward to working with you and your child and sharing in his/her growth and
                            development.</p>
                        <p className="mt-13">Many thanks for choosing The Goddard School® located in Redmond, WA.</p>
                        <p className="mt-13">Sincerely,</p>
                        <p className="mt-13">Maanu Muthu, Onsite Owner</p>
                        <p className="mt-13"><i>*The term “parent” is used throughout to represent the primary individual(s) responsible for the child’s care.</i></p>
