...
const GeneralEnrollmentProcedure = ({fieldValue, openSection, setOpenSection, handleChange: parentHandleChange }) => {
        ...
        <>
            ...
            {isOpen && (
                <div className="border p-6 space-y-6 bg-gray-50" onClick={(e) => e.stopPropagation()}>
                    ...
                    >
                        <h1 className="text-2xl max-sm:text-[17px] font-bold mb-10 text-center">
                            GENERAL INFORMATION
                        </h1>
                        

                        <div className='max-sm:text-[11px] max-sm:-mt-5  max-sm:-mb-5 max-sm:-ml-5 max-sm:-mr-5'>
                        <p className="text-base leading-relaxed  max-sm:text-[11px] mt-4">
                        ...
                        <h1 className="text-2xl font-bold mb-10 mt-10  max-sm:text-[17px]  text-center mt-5">
                        ...
                        <h1 className="text-2xl font-bold mb-10  max-sm:text-[17px]   text-center mt-15">
                            STUDENT RECORDS
                        </h1>
