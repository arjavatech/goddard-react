...
const TransitionToiletTraining = ({fieldValue, openSection, setOpenSection, handleChange: parentHandleChange }) => {
  ...
  `;
        ...
        <>
            ...
            {isOpen && (
                ...
                >
                    ...
                    >
                        {/* --- REST TIME --- */}
                        <h1 className="text-2xl font-bold mb-4 text-center max-sm:text-[17px]">
                        TRANSITION
                        </h1>

                        <p className="text-base leading-relaxed mt-8 max-sm:text-[11px] max-sm:-ml-5 max-sm:-mr-5 ">
   ...
   <h1 className="text-2xl font-bold mb-4 mt-10 text-center max-sm:text-[17px]">
   TOILET TRAINING PHILOSOPHY
                  ...
                  During this process, diapers should be replaced by training pants or pull-ups, and then by regular underwear. As accidents are inevitable, a sufficient supply should be on hand, along with season appropriate clothing changes
                        ...
                        {/* --- MEALS AND SNACKS --- */}
                        <h1 className="text-2xl font-bold mt-10 mb-4 text-center max-sm:text-[17px]">
      ...
      <div className="space-y-6 text-gray-800 leading-relaxed">
        ...
        <div className="space-y-3 ml-4 max-sm:text-[11px] max-sm:-ml-5 max-sm:-mr-5 ">
          <p className="text-base max-sm:text-[11px] max-sm:-ml-5 max-sm:-mr-5 ">
        ...
        <p className="text-base mt-9 max-sm:text-[11px] max-sm:-ml-5 max-sm:-mr-5 ">
        ...
        <div className="text-base mt-9 max-sm:text-[11px] max-sm:-ml-5 max-sm:-mr-5 ">
        ...
        <div className="mt-8">
          <h1 className="text-xl font-semibold text-center mb-6 mt-5 text-gray-800 max-sm:text-[17px]">
          ...
          <p className="text-base mb-9 max-sm:text-[11px] max-sm:-ml-5 max-sm:-mr-5 ">
        ...
        <div className="mt-8">
          <h2 className="text-xl font-bold text-center mb-6 text-gray-800 max-sm:text-[17px]">
            FIELD TRIPS
          </h2>
        ...
        <div className="mt-8">
          <h2 className="text-xl font-bold text-center mb-9 text-gray-800 max-sm:text-[17px]">
